...
const ProfilePage = () => {
  ...
  return (
    <main className={"h-screen overscroll-none bg-gradient-to-t from-black to-[#292F36] text-center"}>
      ...
      <div className={"mt-12"}>
        {
          localProfileImage != "" ?
          <div>
            <img src={localProfileImage} className={"max-h-96 max-w-full mx-auto rounded-md"}/>
            <div>
